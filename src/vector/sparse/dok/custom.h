...
struct DokCustomSparseVector {
    ...
    DokCustomSparseVector() = delete;

    DokCustomSparseVector(const DokCustomSparseVector<T>& other) = delete;

    DokCustomSparseVector(DokCustomSparseVector<T>&& other) noexcept = delete;

    DokCustomSparseVector<T>& operator=(const DokCustomSparseVector<T>& other) = delete;

    DokCustomSparseVector<T>& operator=(DokCustomSparseVector<T>&& other) noexcept = delete;
     ...
     */
    DokCustomSparseVector(const std::size_t n, T*& values, std::size_t*& indices, std::size_t& nnz) : nnz_(nnz), n_(n), values_(values), indices_(indices) {
    }
