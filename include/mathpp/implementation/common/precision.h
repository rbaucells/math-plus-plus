#ifndef MATHPP_IMPLEMENTATION_COMMON_PRECISION_H
#define MATHPP_IMPLEMENTATION_COMMON_PRECISION_H
...
struct Precision {
    ...
    constexpr Precision(const Precision<U>& other) : value(static_cast<T>(other.value)) {}
};
