#ifndef MATHPP_IMPLEMENTATION_VECTOR_COMMON_TRAITS_H
#define MATHPP_IMPLEMENTATION_VECTOR_COMMON_TRAITS_H
...
#endif // MATHPP_IMPLEMENTATION_VECTOR_COMMON_TRAITS_H
