#ifndef MATHPP_IMPLEMENTATION_VECTOR_DENSE_OPERATORS_ADD_ASSIGN_H
#define MATHPP_IMPLEMENTATION_VECTOR_DENSE_OPERATORS_ADD_ASSIGN_H
...
#endif // MATHPP_IMPLEMENTATION_VECTOR_DENSE_OPERATORS_ADD_ASSIGN_H
