#ifndef MATHPP_IMPLEMENTATION_VECTOR_DENSE_OPERATORS_DOT_H
#define MATHPP_IMPLEMENTATION_VECTOR_DENSE_OPERATORS_DOT_H
...
#endif // MATHPP_IMPLEMENTATION_VECTOR_DENSE_OPERATORS_DOT_H
