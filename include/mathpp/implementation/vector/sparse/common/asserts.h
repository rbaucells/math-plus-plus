#ifndef MATHPP_IMPLEMENTATION_VECTOR_SPARSE_COMMON_ASSERTS_H
#define MATHPP_IMPLEMENTATION_VECTOR_SPARSE_COMMON_ASSERTS_H
...
#endif // MATHPP_IMPLEMENTATION_VECTOR_SPARSE_COMMON_ASSERTS_H
