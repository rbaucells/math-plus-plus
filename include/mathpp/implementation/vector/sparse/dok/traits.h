#ifndef MATHPP_IMPLEMENTATION_VECTOR_SPARSE_DOK_TRAITS
#define MATHPP_IMPLEMENTATION_VECTOR_SPARSE_DOK_TRAITS
...
#endif // MATHPP_IMPLEMENTATION_VECTOR_SPARSE_DOK_TRAITS
