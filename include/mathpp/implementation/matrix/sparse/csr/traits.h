#ifndef MATHPP_IMPLEMENTATION_MATRIX_SPARSE_CSR_TRAITS
#define MATHPP_IMPLEMENTATION_MATRIX_SPARSE_CSR_TRAITS
...
#endif // MATHPP_IMPLEMENTATION_MATRIX_SPARSE_CSR_TRAITS
