#ifndef MATHPP_IMPLEMENTATION_MATRIX_SPARSE_COMMON_TRAITS_H
#define MATHPP_IMPLEMENTATION_MATRIX_SPARSE_COMMON_TRAITS_H
...
#endif // MATHPP_IMPLEMENTATION_MATRIX_SPARSE_COMMON_TRAITS_H
