#ifndef MATHPP_IMPLEMENTATION_MATRIX_DENSE_OPERATORS_MULTIPLY_H
#define MATHPP_IMPLEMENTATION_MATRIX_DENSE_OPERATORS_MULTIPLY_H
...
#endif // MATHPP_IMPLEMENTATION_MATRIX_DENSE_OPERATORS_MULTIPLY_H
