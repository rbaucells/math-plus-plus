#ifndef MATHPY_MATRIX_DENSE_OPERATORS_ADD_H
#define MATHPY_MATRIX_DENSE_OPERATORS_ADD_H
...
template<typename T>
bool matrix_dense_operators_add(const std::size_t size, const py::sequence sequence) {
...
template<typename T>
bool matrix_dense_operators_add(const std::size_t size, const py::array array) {
    auto wrapper = std::views::iota(0u, size) | std::views::transform([&](const std::size_t i) -> DenseMatrixLikePyWrapper<T> {
...
#endif //MATHPY_MATRIX_DENSE_OPERATORS_ADD_H
