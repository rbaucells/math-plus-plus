...
TEST(dense_matrix_addition_operator, given_f_dense_matrices_should_add_assign) {
    // arrange
...
TEST(dense_matrix_addition_operator, given_cf_dense_matrices_should_add_assign) {
    // arrange
...
TEST(dense_matrix_addition_operator, given_f_and_cf_dense_matrices_should_add_assign) {
    // arrange
    DenseMatrix<std::complex<float>> a = {{{2, 6}, {3, 6}, {0, 8}}, {{2, 1}, {3, 7}, {1, 0}}, {{4, 7}, {3, 3}, {5, 9}}};
    const DenseMatrix<float> b = {{2, 5, 8}, {1, 7, 31}, {8, 2, 7}};
    const DenseMatrix<std::complex<float>> c = {{{3, 6}, {3, 3}, {1, 6}}, {{8, 4}, {4, 1}, {5, 1}}, {{0, 7}, {8, 5}, {3, 21}}};
